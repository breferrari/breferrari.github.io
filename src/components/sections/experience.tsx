    ...
    <section id="experience" className="scroll-mt-20 px-6 py-12">
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="relative flex flex-col">
          ...
          <div className="absolute left-[calc(0.375rem-0.5px)] top-0 bottom-0 w-px bg-warm/30" style={{ maskImage: "linear-gradient(to bottom, transparent, white 3%, white 97%, transparent)", WebkitMaskImage: "linear-gradient(to bottom, transparent, white 3%, white 97%, transparent)" }} />
